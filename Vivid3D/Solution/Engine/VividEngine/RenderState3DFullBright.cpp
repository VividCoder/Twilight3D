...
RenderState3DFullBright::RenderState3DFullBright() {
    ...
    RefCntAutoPtr<IShader> pVS;
    {
        ...
        ShaderCI.FilePath = Vivid::App::VividApp::GetResPath("render3DFullBright.vsh");
    ...
    RefCntAutoPtr<IShader> pPS;
    {
        ...
        ShaderCI.FilePath = Vivid::App::VividApp::GetResPath("Render3DFullBright.psh");
